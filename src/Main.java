public class Main {
    ...
    public static void task8() {
        ...
        var companyExpanded = totalEmployees + 94;
        var individualTime = totalTime / companyExpanded;
        System.out.println("Если в компании работает " + companyExpanded + " человека, то всего " + individualTime + " часа работы может быть поделено между сотрудниками");
    }
}